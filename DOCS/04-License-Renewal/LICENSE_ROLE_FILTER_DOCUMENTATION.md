...
| DEVELOPER | ✅ Allowed | ✅ Allowed | ✅ Allowed | ❌ Forbidden (403) | ✅ Allowed |

**Note**: Based on the current implementation in `StandaloneOTPServlet.java`, only DEVELOPER role can access developer OTP endpoints, and only ADMIN role can access admin OTP endpoints.
...
- `SYSTEM_BACKUP` - System backup operations
